                ...
                <div className="w-full max-w-md text-center">
                    <div className="glass-panel p-8 rounded-[32px]">
                        <div className="w-16 h-16 rounded-full bg-[var(--success)]/20 flex items-center justify-center mx-auto mb-4">
                            <div className="w-8 h-8 rounded-full bg-[var(--success)]" />
                        </div>
                        <h1 className="text-2xl font-bold mb-2">登録完了！</h1>
                        <p className="text-[var(--text-dim)] mb-6">
                            アカウントが作成されました。<br />
                            ログインしてトレーニングを開始しましょう。
                        </p>
                        <Link href="/app" className="inline-block px-6 py-3 rounded-xl bg-[var(--primary)] text-white font-bold hover:scale-105 transition-all">
                            トレーニングを開始
                        </Link>
                    </div>
                </div>
        ...
        <div className="min-h-screen bg-[var(--bg-deep)] text-[var(--text-main)] flex items-center justify-center p-6">
            <div className="w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-[var(--text-dim)]">無料でアカウントを作成</p>
                </div>
                ...
                <div className="glass-panel p-8 rounded-[32px]">
                    ...
                    <form onSubmit={handleEmailSignUp} className="space-y-4 mb-6">
                        ...
                        <div>
                            <label className="block text-sm font-bold mb-2">パスワード（6文字以上）</label>
                            <div className="relative">
